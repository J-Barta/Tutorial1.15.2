...
public class MedleyChunkGenerator extends NoiseChunkGenerator<MedleyGenSettings> {
    ...
    public MedleyChunkGenerator(IWorld worldIn, BiomeProvider provider, MedleyGenSettings settingsIn) {
